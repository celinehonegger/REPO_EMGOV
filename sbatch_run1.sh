#!/bin/bash
#SBATCH --job-name=run1_swissrelated
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=04:00:00
#SBATCH --output=logs/run1_swissrelated_%j.out
#SBATCH --error=logs/run1_swissrelated_%j.err
...
WORKDIR=/work/FAC/FDCA/IDHEAP/mhinterl/parp/REPO_EMGOV
SCRATCHDIR=/scratch/chonegg2
OUTDIR=/work/FAC/FDCA/IDHEAP/mhinterl/parp/REPO_EMGOV/data/processed
OUTBASE="/work/FAC/FDCA/IDHEAP/mhinterl/parp/REPO_EMGOV/data/processed/emgov_sentences_with_s"
...
cp "src/run1_prompts.py" "$RUN_DIR/prompts_used.py"
